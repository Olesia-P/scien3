...
export const textMassProduction = {
  ...
  useCases: {
    ...
    list: [
      <>
        <strong>Створення прототипів.</strong> Наприклад, для тестування,
        доопрацювання або презентації нових продуктів перед запуском у масове
        виробництво.
      </>,
      <>
        <strong>Невеликі серії товарів.</strong> Якщо потрібна обмежена
        кількість деталей для продажу.
      </>,
      <>
        <strong>Запчастини та аксесуари.</strong> Особливо коли виробництво
        оригінальних деталей уже припинено.
      </>,
      <>
        <strong>Форс-мажори.</strong> У разі непередбачених обставин, пов’язаних
        з терміном поставок необхідних деталей (затримки у виробництві, проблеми
        перетину кордонів, занадто віддалена локація виробника).
      </>,
    ],
  },
  ...
  stages: {
    ...
    nestedList: [
      {
        header: 'Початковий етап – створення майстер-моделі',
        paragraphs: [
      ...
      {
        header: 'Заливка пластику у вакуумі',
        paragraphs: [
      ...
      {
        header: 'Затвердіння та фінальні роботи',
        paragraphs: [
  ...
  whyNot3Dprinting: {
    ...
    paragraphs: [
      ...
      'З ключових недоліків 3D-друку виділяють:',
    ],
    list: [
