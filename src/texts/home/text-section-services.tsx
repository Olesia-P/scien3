  ...
  services: [
    {
      ...
      img: '/services/home/3d_modeling.jpg',
      webp: '/services/home/3d_modeling.webp',
      alt: '3D моделювання.',
    },
    {
      name: 'Серійне лиття',
      link: '/ua/services/serial-production',
      img: '/services/home/serial_production.jpg',
      webp: '/services/home/serial_production.webp',
      alt: 'Серійне лиття пластикових виробів.',
    },
    {
      name: '3D друк',
      link: '/ua/services/printing-3D',
      img: '/services/home/3d_printer.jpg',
      webp: '/services/home/3d_printer.webp',
      alt: '3D-принтер.',
    },
    {
      name: 'Форми для лиття',
      link: '/ua/services/molds',
      img: '/services/home/silicone_mold.jpg',
      webp: '/services/home/silicone_mold.webp',
