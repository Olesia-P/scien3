const ua = {
  statements: [
    ...
    },
    {
      ...
      img: '/marketing/multiple_details.png',
      webp: '/marketing/multiple_details.webp',
    ...
    },
    {
      ...
      img: '/marketing/detail_replacement.png',
      webp: '/marketing/detail_replacement.webp',
      alt: 'Зламана деталь поряд із ідентичною цілою деталлю.',
    },
    {
      question: 'Вашій колекції не вистачає фігурки лепрекона?',
      answer:
      ...
      webp: '/marketing/leprechaun.webp',
      alt: 'Пластикова фігурка лепрекона.',
    },
    {
      question: 'Власноруч робите мило або шоколадки?',
      answer:
        'Виготовимо  унікальні силіконові форми, яких не буде ні у кого, крім вас.',
      img: '/marketing/soap_silicone_mold.png',
      webp: '/marketing/soap_silicone_mold.webp',
...
const en = {
  statements: [
    {
      question: 'Do you have an idea but don’t know where to start?',
      answer:
    ...
    {
      question: 'Is your collection missing a leprechaun figurine?',
      answer:
